...
import PreactImage from './assets/logo.png';
...
export const SolutionPreactPage = () => {
  return (
      ...
      <section className="ds-container" id="getting-started">
        <article className="step">
          ...
          <div className="heading-group">
            ...
            <p>Add Capacitor to your project and create a config for your app</p>
          </div>
...
npx cap init [name] [id] --web-dir=build`}
        ...
        <article className="step">
          ...
          <div className="code-panel">
            <pre>
              <HighlightedCode theme={nightOwl} language="shell-session" code={`npm run build`} />
            </pre>
          </div>
        </article>
...
export default SolutionPreactPage;
