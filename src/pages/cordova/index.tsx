...
git checkout -b cap-migration
    ...
    <article className="step">
      ...
      <div className="heading-group">
        ...
        <p>
          Create the Capacitor app using the Cordova app's name and id found in
          `config.xml`.
        </p>
      </div>
      <div className="code-panel">
...
`}
    ...
    <article className="step">
      ...
      <div className="heading-group">
        ...
        <p>
          Reuse the existing splash screen/icon images, located in the top-level
          `resources` folder of your Cordova project, using the `cordova-res`
          tool. Images are copied into each native project.
        </p>
      </div>
      <div className="code-panel">
        <pre>
    ...
    <article className="step">
      ...
      <div className="heading-group">
        ...
        <p>
          ...
          plugins. You may be able to switch to the Capacitor-equivalent Cordova
          plugin, such as the Camera.
        </p>
    ...
    <article className="step">
      ...
      <div className="heading-group">
        ...
        <p>
          ...
          <a href="/docs/basics/workflow">development workflow</a>, or create
